...
public final class javabean_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("<head>\n");
      out.write("<title>JAVABEAN</title>\n");
      out.write("</head>\n");
      out.write("<body bgcolor=\"#ffffff\">\n");
      out.write("\n");
      paquete.DB manejador = null;
      synchronized (session) {
        manejador = (paquete.DB) _jspx_page_context.getAttribute("manejador", PageContext.SESSION_SCOPE);
        if (manejador == null){
          manejador = new paquete.DB();
